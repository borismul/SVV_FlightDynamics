...
function[hp,Vc,alpha,delta_e,delta_e_t,Fe,Mfl,Mfr,Fuel_used,Tm,Fuel_start,Payload] = Import_of_measured_data(filename)
...
Mfl = cat(1,xlsread(filename,'J43:J49'),xlsread(filename,'J59:J60'));
Mfr = cat(1,xlsread(filename,'K43:K49'),xlsread(filename,'K59:K60'));
...
Payload = xlsread(filename,'H8:H16');
